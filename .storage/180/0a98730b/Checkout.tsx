...
export default function CheckoutPage() {
  ...
  useEffect(() => {
    ...
    if (cart.length === 0) {
      toast({
        ...
        description: 'Keranjang Anda kosong. Tambahkan beberapa produk terlebih dahulu.',
      });
      navigate('/');
    }
  }, [navigate, toast]);
  ...
  const handleCheckoutSuccess = () => {
    ...
    toast({
      ...
      description: 'Pesanan Anda telah dibuat dan sedang menunggu konfirmasi.'
    });
    navigate('/orders');
  };
          ...
          <div className="lg:col-span-5">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  {cartItems.length} {cartItems.length === 1 ? 'produk' : 'produk'} dalam keranjang Anda
                </CardDescription>
              </CardHeader>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground">
                            Jumlah: {item.quantity} × {formatPrice(getPriceForUser(product, userType))}
                          </p>
                        </div>
                      </div>
