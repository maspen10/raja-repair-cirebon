...
import { getProducts, getUsers, updateTransactionStatus, getCurrentUser, getDeliveryMethods, getPaymentMethods } from '@/lib/storage';
  ...
  const getStatusMessage = () => {
    switch(transaction.status) {
      ...
      case 'payment_confirmed': 
        return "Payment has been confirmed. The order is awaiting processing.";
      case 'processing': 
      ...
      <Dialog open={isShippingDialogOpen} onOpenChange={setIsShippingDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Confirm that this order has been shipped to the customer.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            ...
            <Button onClick={() => handleStatusChange('shipping')}>
              Yes, Mark as Shipped
            </Button>
          </DialogFooter>
        </DialogContent>
