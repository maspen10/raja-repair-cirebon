...
export function AdminLayout({ children }: AdminLayoutProps) {
  ...
  const menuItems = [
    ...
    { name: 'Outgoing Products', path: '/admin/transactions/out', icon: <ShoppingCart className="h-5 w-5" /> },
    { name: 'Incoming Products', path: '/admin/transactions/in', icon: <PackageOpen className="h-5 w-5" /> },
